...
/*
  ...
  TFile fData(TString::Format("/home/xuansun/Documents/Analysis_Code/FierzWork_2011-2013/PositionCuts/radialCut_%i-%i/Octet_%i_ssDataHist_%s_radialCut_%i-%imm_endpointCorr_Sn113Stitch_try3.root", RADLOW, RADHIGH, octNb, TYPE, RADLOW, RADHIGH));
...
*/
  ...
  ofstream outfile;
  outfile.open(Form("allOctets_positionCuts_%i-%imm_endpointCorrected_withFullBlind_Feb2019_%s_%s_Sn113Stitch_try3.2.txt", RADLOW, RADHIGH, TYPE, GEOM), ios::app);
