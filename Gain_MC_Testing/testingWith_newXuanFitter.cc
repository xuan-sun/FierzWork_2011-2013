...
int main(int argc, char* argv[])
{
  ...
  cout << "Total beta events: " << betaChain->GetEntries() << endl;
  ...
  cout << "Total fierz events: " << fierzChain->GetEntries() << endl;
...
*/
  ...
  t2.SetTextSize(0.03);
  t2.SetTextAlign(13);
  t2.DrawLatex(600, 0.014, Form("#frac{#Chi^{2}}{NDF} = %f / %f = %f", functionMin, ndf, functionMin/ndf));
  TLatex t3;
  t3.SetTextSize(0.03);
  t3.SetTextAlign(13);
