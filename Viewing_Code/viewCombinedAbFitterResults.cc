...
//  int option = atoi(argv[1]);
  ...
  FillArrays(Form("../CombinedAbFitter/CorrectBlindingOct2018_combinedAbFitter_OneOctetbAndA_NoSuperSum_%s_%s_Bins_%i-%i.txt", TYPE, GEOM, FITMINBIN, FITMAXBIN), hbFitValues, 1);
