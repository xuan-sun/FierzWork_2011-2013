...
//----------------------------------------------//
  ...
  // octet 80
  TDatime da80(2012, 12, 7, 0, 00, 00);
  TIME_2012.push_back(da80.Convert());

  // octet 81
  TDatime da81(2012, 12, 7, 12, 00, 00);
  TIME_2012.push_back(da81.Convert());

  // octet 82
  TDatime da82(2012, 12, 8, 0, 00, 00);
  TIME_2012.push_back(da82.Convert());

  // octet 83
  TDatime da83(2012, 12, 8, 12, 00, 00);
  TIME_2012.push_back(da83.Convert());

  // octet 84
  TDatime da84(2012, 12, 9, 0, 00, 00);
  TIME_2012.push_back(da84.Convert());

  // octet 85
  TDatime da85(2012, 12, 10, 0, 00, 00);
  ...
  // octet 87
  TDatime da87(2012, 12, 12, 18, 00, 00);
  TIME_2012.push_back(da87.Convert());

  // octet 88
  TDatime da88(2012, 12, 14, 0, 00, 00);
  TIME_2012.push_back(da88.Convert());

  // octet 89
  TDatime da89(2012, 12, 14, 12, 00, 00);
  TIME_2012.push_back(da89.Convert());

  // octet 90
  TDatime da90(2012, 12, 15, 0, 00, 00);
...
//  TIME.push_back(da93.Convert());
  ...
  // octet 94
  TDatime da94(2012, 12, 17, 0, 00, 00);
  TIME_2012.push_back(da94.Convert());

  // octet 95
  TDatime da95(2012, 12, 17, 12, 00, 00);
  ...
  // octet 97
  TDatime da97(2013, 1, 11, 16, 00, 00);
  TIME_2012.push_back(da97.Convert());

  // octet 98
  TDatime da98(2013, 1, 12, 12, 00, 00);
  TIME_2012.push_back(da98.Convert());

  // octet 99
  TDatime da99(2013, 1, 13, 8, 00, 00);
  TIME_2012.push_back(da99.Convert());

  // octet 100
  TDatime da100(2013, 1, 14, 0, 00, 00);
...
//  TIME.push_back(da101.Convert());
  ...
  // octet 102
  TDatime da102(2013, 1, 17, 16, 00, 00);
  TIME_2012.push_back(da102.Convert());

  // octet 103
  TDatime da103(2013, 1, 18, 12, 00, 00);
  TIME_2012.push_back(da103.Convert());

  // octet 104
  TDatime da104(2013, 1, 19, 8, 00, 00);
  TIME_2012.push_back(da104.Convert());

  // octet 105
  TDatime da105(2013, 1, 20, 0, 00, 00);
  TIME_2012.push_back(da105.Convert());

  // octet 106
  TDatime da106(2013, 1, 20, 16, 00, 00);
...
//  TIME.push_back(da107.Convert());
  ...
  // octet 108
  TDatime da108(2013, 1, 22, 0, 00, 00);
  TIME_2012.push_back(da108.Convert());

  // octet 109
  TDatime da109(2013, 1, 22, 16, 00, 00);
  TIME_2012.push_back(da109.Convert());

  // octet 110
  TDatime da110(2013, 1, 25, 0, 00, 00);
  TIME_2012.push_back(da110.Convert());

  // octet 111
  TDatime da111(2013, 1, 25, 16, 00, 00);
  TIME_2012.push_back(da111.Convert());

  // octet 112
  TDatime da112(2013, 1, 26, 12, 00, 00);
  TIME_2012.push_back(da112.Convert());

  // octet 113
  TDatime da113(2013, 1, 27, 8, 00, 00);
  TIME_2012.push_back(da113.Convert());

  // octet 114
  TDatime da114(2013, 1, 28, 0, 00, 00);
  TIME_2012.push_back(da114.Convert());

  // octet 115
  TDatime da115(2013, 1, 30, 0, 00, 00);
  TIME_2012.push_back(da115.Convert());

  // octet 116
  TDatime da116(2013, 2, 1, 0, 00, 00);
  TIME_2012.push_back(da116.Convert());

  // octet 117
  TDatime da117(2013, 2, 2, 0, 00, 00);
  TIME_2012.push_back(da117.Convert());

  // octet 118
  TDatime da118(2013, 2, 2, 12, 00, 00);
  TIME_2012.push_back(da118.Convert());

  // octet 119
  TDatime da119(2013, 2, 3, 0, 00, 00);
  TIME_2012.push_back(da119.Convert());

  // octet 120
  TDatime da120(2013, 2, 3, 12, 00, 00);
