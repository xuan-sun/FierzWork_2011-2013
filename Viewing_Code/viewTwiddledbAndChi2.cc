...
//    FillArrays(Form("AsymmetricTwiddledbValues_secondPass_noAsymm100MillBLINDEDBaseline_A_1_b_0_newXuanFitter_%s_%s_Bins_%i-%i.txt", TYPE, GEOM, FITMINBIN, FITMAXBIN), hADownbFit, option);
//    FillArrays(Form("AsymmetricTwiddledbValues_secondPass_noAsymm100MillBLINDEDBaseline_A_1_b_0_newXuanFitter_%s_%s_Bins_%i-%i.txt", TYPE, GEOM, FITMINBIN, FITMAXBIN), hAUpbFit, option);
...
//    PlotHist(C, 1, 1, hADownbFit, Form("b fit results, %s, %s", TYPE, GEOM), "b", "N", "", max);
    PlotHist(C, 2, 1, hAUpbFit, Form("b fit results, %s, %s", TYPE, GEOM), "b", "N", "", max);
...
//    leg1->AddEntry(hADownbFit,"A=-1, b twiddles","f");
    ...
    C -> Print(Form("SymmetricTwiddledb_bValues_viewTwiddledbAndChi2_%s_%s_Bins_%i-%i.pdf", TYPE, GEOM, FITMINBIN, FITMAXBIN));
  }
  else if(option == 2)
  {
