...
int main(int argc, char *argv[])
{
  ...
  errEnv2011_top_2sigma -> GetYaxis() -> SetRangeUser(-20, 10);
...
void LoadEnvelopeHistogram()
{
  TString fileName = "/home/xuansun/Documents/Analysis_Code/FierzWork_2011-2013/MB_errorEnvelopes_publication/MB_ErrorEnvelope_2011-2012_asymmetric.txt";
