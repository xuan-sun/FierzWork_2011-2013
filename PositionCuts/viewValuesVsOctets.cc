...
//  h1->SetStats(0);
  ...
  FillArrays(Form("positionCuts_0-15mm_FullBlindFeb2019_newXuanFitter_dataHists_bFit_%s_%s_Bins_%i-%i.txt", TYPE, GEOM, FITMINBIN, FITMAXBIN), h2, 2);
  ...
  g1->GetYaxis()->SetRangeUser(-0.4, 0.3);

  PlotGraph(C, 2, 1, g1, Form("b for %s: 0-15mm radius", GEOM), "Octet Number", "b", "AP");
  PlotGraph(C, 4, 1, g2, Form("b for %s: 0-15mm radius", GEOM), "Octet Number", "b", "PSAME");
