...
//  int option = atoi(argv[1]);
  ...
  FillArrays(Form("newFitWindow_endPointFits_noCorrection_ssDataHists_type0_2012-2013_radialCut_0-49mm_Bins_20-70.txt"), h, 1);

  int max = h->GetMaximum();

  PlotHist(C, 2, 1, h, Form("optimized fit window, endpoints octets, %s, %s, radial: 0-49mm", TYPE, GEOM), "fitted end point (keV)", "N", "", max);
